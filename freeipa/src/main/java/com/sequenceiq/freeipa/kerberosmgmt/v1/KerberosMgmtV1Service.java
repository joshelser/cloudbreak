...
public class KerberosMgmtV1Service {
    ...
    public void deleteHost(HostRequest request, String accountId) throws FreeIpaClientException {
        ...
        Map<String, String> principalCanonicalMap = ipaClient.findAllService().stream()
        ...
        Set<String> services = principalCanonicalMap.entrySet().stream().filter(e -> e.getKey().contains(request.getServerHostName()))
    ...
    private com.sequenceiq.freeipa.client.model.Service serviceAdd(ServiceKeytabRequest request, String realm, FreeIpaClient ipaClient)
        ...
        String canonicalPrincipal = constructCanonicalPrincipal(request.getServiceName(),
                request.getServerHostName(), realm);
    ...
    public static String constructCanonicalPrincipal(String serviceName, String hostName, String realm) {
